...
static const float ERROR_TOLERANCE_DEG = 1; // allowable error in deg
static const float ERROR_TOLERANCE_DEGMS = 1;
static const float ERROR_TOLERANCE_TICKS = degToTicks(ERROR_TOLERANCE_DEG); // allowable error in ticks
